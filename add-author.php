	...
	<body>
		...
		<div class="d-flex justify-content-center align-items-center vh-100">
			<div class="form-container w-100" style="max-width: 500px;">
				<h2 class="text-center mb-2 fw-bold text-primary display-10"><i class="fas fa-folder-plus me-2"></i>Add New Author</h2>
				...
				<form action="php/add-author.php" method="post">
					<div class="mb-4">
						<label for="author_name" class="form-label fw-bold text-secondary">Author Name</label>
						<div class="input-group shadow-sm">
							<span class="input-group-text bg-primary text-white">
								<i class="fas fa-tag"></i>
							</span>
							<input type="text" class="form-control form-control-lg" id="author_name" name="author_name" placeholder="Enter author name" required>
						</div>
					</div>
					<button type="submit" class="btn btn-primary btn-lg w-100 shadow-sm rounded-3 py-2"><i class="fas fa-plus-circle me-2"></i>Add Author</button>
				</form>
			</div>
		</div>
